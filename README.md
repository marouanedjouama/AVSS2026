...
``` bash
python train_brats.py --brats 2020 --config configs/config_mmDiT_brats20.json --name Run_1 --batch-size 32 --max-epochs 300 --wandb-project AVSS-brats2020 --sample-steps 5 --evaluate-n 15 --evaluate-every 25000 --use-early-stopping --compile --mixed-precision bf16
```
