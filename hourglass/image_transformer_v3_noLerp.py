"""k-diffusion transformer diffusion models, version 4.
...
The conditioning features are fused into the main encoder with simple
addition at each encoder scale before the main bottleneck.
"""
