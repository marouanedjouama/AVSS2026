...
Adapted from RectifiedFlow/models/ema.py with minor cleanups.
"""
...
class ExponentialMovingAverage:
    ...
    def __init__(self, parameters, decay, use_num_updates=True):
        """
        Args:
            parameters: Iterable of torch.nn.Parameter (usually model.parameters()).
            decay: The exponential decay rate.
            use_num_updates: Whether to use warmup via num_updates.
        """
